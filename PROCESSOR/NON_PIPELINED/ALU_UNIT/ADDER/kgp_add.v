...
always @(*)
begin
        sum[0] = i1[0] ^ i2[0] ^ kgp4[0];
        sum[1] = i1[1] ^ i2[1] ^ kgp4[1];
        sum[2] = i1[2] ^ i2[2] ^ kgp4[2];
        sum[3] = i1[3] ^ i2[3] ^ kgp4[3];
        sum[4] = i1[4] ^ i2[4] ^ kgp4[4];
        sum[5] = i1[5] ^ i2[5] ^ kgp4[5];
        sum[6] = i1[6] ^ i2[6] ^ kgp4[6];
        sum[7] = i1[7] ^ i2[7] ^ kgp4[7];
